  ...
  context "BERT" do
    setup do
      ...
      @berts = {
        ...
        :v3 => "\x85\x99\xA4user\x93\xA4bert\xA4dict\x91\x92\xA4name\xA3TPW\x92\x94\xA4bert\xA5regex\xA3cat\x91\xA8caseless\xCB@#\xCC\xCC\xCC\xCC\xCC\xCD\x95\xA4bert\xA4time\xCD\x04\xE6\xCE\x00\x0E\xE4\xC3\x00\x92\xA4bert\xA3nil\x92\xA4bert\xA4true\x92\xA4bert\xA5false\xA4true\xA5false".b,
      }
      @ebins = {
